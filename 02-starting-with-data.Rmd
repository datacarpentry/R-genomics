...
We're going to download the data through R. 

```{r, eval=TRUE,  purl=FALSE}
download.file("http://datacarpentry.github.io/R-genomics/data/Ecoli_metadata.csv", "Ecoli_metadata.csv")
```
...
Based on the list of functions above to assess data structure, can you answer the following questions?
