...
* Enter a name for this new folder, and choose a convenient location for
  ...
  (e.g., `~/data-carpentry`)
* Confirm that the folder named in the `Create project as a sub-directory of` box is where you want the working directory created. Use the `Browse` button if changes are needed.
